...
function TestimonialCard() {
    return (
        <div class="space-y-4 max-w-md mx-auto">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-red-500" viewBox="0 0 35 30" fill="none">
                <path
            ...
            <div class="flex items-center gap-2"><img alt="Yifan testimonial for ShipFast" loading="lazy" width="48" height="48" decoding="async" data-nimg="1" class="w-10 h-10 rounded-full object-cover" src="https://images.unsplash.com/photo-1566492031773-4f4e44671857?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxMnx8bWFufGVufDB8MXx8fDE2OTYxNzE4MzN8MA&ixlib=rb-4.0.3&q=80&w=1080"/>
