...
function TestimonialCard( {customer, message , img}) {
    return (
        <div class="space-y-4 max-w-md mx-auto  flex flex-col items-center text-center">
            ...
            <p class="md:text-lg leading-relaxed text-center ">{ message }</p>
            <div class="flex items-center gap-2 text-center sm:text-left">
                <img alt="Yifan testimonial for ShipFast" loading="lazy" width="48" height="48" decoding="async" data-nimg="1" class="w-10 h-10 rounded-full object-cover" src={img}/>
                <p><span class="font-bold">{customer}</span></p>
            </div>
        </div>
    )
};
