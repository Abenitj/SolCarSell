...
export default function Accordion({ title, description, answer }) {
  ...
  return (
    <div className="">
      <div className="bg-white border-[1px] border-black px-8 py-5">
        ...
        <p className="text-xl text-gray-800 pt-2">{description}</p>
        {open && (
          <>
            <div className="h-[2px] bg-gray-500 w-1/3 mt-5"></div>
            <p className="text-xl text-gray-700 pt-2">{answer}</p>
          </>
        )}
      </div>
    </div>
